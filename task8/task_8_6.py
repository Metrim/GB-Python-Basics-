...
class Warehouse:
    ...
    def move_asset(self, source, desti, source_type, amount):
        try:
            ...
            print(f"::::Please Input correctly source, destination and device type - you have entered: {source}, "
                  f"{desti} and {source_type}::::")
        except ValueError:
