...
class Cell():
    ...
    def __sub__(self, other):
        if self.amount - other.amount <= 0:
            return "Клетку невозможно получить - отрицательное число элементов"
        else:
            return Cell(self.amount - other.amount)
...
print(my_cell + my_cell_1)
print(my_cell - my_cell_1)
print(my_cell - my_cell_2)
print(my_cell * my_cell_1)
print(my_cell / my_cell_1)

my_cell.make_order(5)
my_cell_1.make_order(3)
my_cell_2.make_order(1)
